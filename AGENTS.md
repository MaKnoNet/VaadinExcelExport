# Projekt-Konventionen - VaadinExcelExport
...
- **OKF-Bundle:** `docs/okf/vaadinexcelexport/` – kuratierte Konzept-Dokumente (Architektur,
...
1. **OKF-Konzepte aktualisieren:** alle Konzepte unter `docs/okf/vaadinexcelexport/`, die
   von den Änderungen dieses Commits berührt sind (neue Komponente → neues Konzept mit
...
2. **`docs/okf/vaadinexcelexport/log.md`:** Eintrag unter dem heutigen ISO-Datum ergänzen
   (neueste zuerst).
