...
Klasse/Methode, aber keine Semantik. Das OKF-Bundle unter `docs/okf/vaadinexcelexport/` ist die
...
- **Querverweise** immer bundle-root-absolut: `[XmlViewer](/components/xmlviewer.md)`
  (beginnt mit `/`, relativ zur Bundle-Wurzel `docs/okf/vaadinexcelexport/`) — **nicht**
...
5. `docs/okf/vaadinexcelexport/log.md` einen Eintrag unter dem heutigen ISO-Datum hinzufügen
